  ...
  <div>
    <div class="date-picker">
      <div class="picker-top">
        ...
        <span class="date-text">{{ month > 9 ? month : "0" + month }}月</span>
        ...
        <table>
          ...
          <tbody>
            <tr v-for="idx in weekNum" :key="'weekNum' + idx">
              ...
              >
                <span
                  style="background: #edf8ff; color: #25a6ff"
                  v-if="
                    timeTips(
                ...
                <span
                  style="background: #eaeaea; color: #999999"
                  v-else-if="
                    timeTips(
                      new Date(monthList[idx - 1][m - 1]).getFullYear(),
                      new Date(monthList[idx - 1][m - 1]).getMonth() + 1,
                ...
                <span
                  style="background: #fff6aa; color: #999999"
                  v-else-if="
                    timeTips(
                      new Date(monthList[idx - 1][m - 1]).getFullYear(),
                      new Date(monthList[idx - 1][m - 1]).getMonth() + 1,
      ...
      for (let i = 0; i < this.time.length; i++) {
        if (this.time[i].date == date) {
          ...
          if (this.roles == 2) {
            ...
            if (this.time[i].state == 2) {
              this.$toast("已错过打卡时间");
              return false;
            }
            if (this.time[i].state == 4) {
              this.$toast("暂未开启打卡");
              return false;
            }
          }
    ...
    table {
      ...
      tbody {
        tr {
          ...
          td.active {
            span {
              border-color: #388dea !important;
              color: #388dea !important;
