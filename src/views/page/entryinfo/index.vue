<template>
  <div
    class="h-container"
    v-if="relicsDataInfo"
    :style="returnIcon ? { 'padding-top': '45px' } : ''"
  >
    <div class="return-head" v-if="returnIcon">
      <div class="return-head-home" @click="repHome">
        <van-icon name="wap-home-o" />
      </div>
      <div class="return-head-text">
        <div class="retrun-head-logo">
          <img :src="relicsDataInfo.muse_info.logo" alt="" />
        </div>
        <p>{{ relicsDataInfo.muse_info.muse_name }}</p>
      </div>
    </div>
    ...
    <div class="v-image-box" v-else>
      <img
        class="v-image"
        mode="widthFix"
        :data-src="relicsDataInfo.image"
        :src="relicsDataInfo.image"
      />
      <div
        class="v-image-audio"
        @click="playAudio"
    ...
    <div class="app-info-box">
      <div class="app-info-title">
        {{ relicsDataInfo.name }}
        <div
          class="app-info-title-content"
          :style="{ color: relicsDataInfo.is_like == 0 ? '' : '#5287fd' }"
          @click="linkFn(relicsDataInfo)"
          v-if="Show"
        >
    ...
    <div class="author-box">
      ...
      <div class="author-body">
        <span v-if="relicsDataInfo.author"
          >最近更新：{{ relicsDataInfo.author }} ({{
            relicsDataInfo.create_time
          }})</span
        >
        <span
          @click="
            jumpRoute('/report', { id: id, muse_id: relicsDataInfo.muse_id })
          "
      ...
      <div class="app-subscribe" v-if="Show">
        <div class="app-subscribe-title">
          <div class="app-subscribe-icont">
            <img src="@/assets/images/subscribe.png" alt="" />
          </div>
          <span
            class=""
            v-if="relicsDataInfo.subscribe == 0"
            @click="wrapper_show = true"
            >订阅</span
          >
          <span
            class=""
            v-if="relicsDataInfo.subscribe == 1"
            @click="unsubscribe"
            >取消订阅</span
          >
        </div>
      ...
      <div class="app-info-jump-list">
        <template>
          <div class="infinite-list-wrapper">
            ...
            >
              <div
                class="app-pl-list-item"
                v-for="(sitem, index) in commentList"
                :key="index + 'index'"
              >
                <!--            用户头像-->
                ...
                <div class="app-pl-list-item-body">
                  ...
                  <div class="app-pl-list-item-info">
                    <div class="app-pl-list-item-user">
                      <span class="app-pl-user">{{
                        sitem.user_info.nickname
                      }}</span>
                      <span v-if="sitem.official == 1" class="app-pl-tip"
                        >官方</span
                      >
                    </div>
                  </div>
                  ...
                  <div class="app-pl-list-item-cont">
                    ...
                    <div v-if="sitem.image">
                      <div class="pl-images-box">
                        <img
                          class="pl-images"
                          v-for="(imgList, j) in sitem.image"
                          :for-item="imgList"
                          :key="j"
                          :data-index="j"
                          :data-imgs="imgList"
                    ...
                    <div v-if="sitem.voice">
                      <div class="app-pl-voice" :data-voice="sitem.voice">
                        <img
                          src="@/assets/images/playly-icon.png"
                          mode="aspectFill"
                        />
                  ...
                  <div class="app-pl-list-item-item">
                    ...
                    <div class="pl-tips" v-if="Show">
                      <div
                        class="app-pl-item-link"
                        :style="{ color: sitem.is_like == 0 ? '' : '#5287fd' }"
                        :data-commentid="sitem.id"
                        :data-index="index"
                        @click="CommentLike($event, sitem)"
                      >
                      ...
                      <button>
                        <div
                          class="pl-hf"
                          :data-reply_id="sitem.id"
                          :data-index="index"
                          :data-username="sitem.user_info.nickname"
                          @click="hfSetFocus($event, index)"
                        >
                  ...
                  <div class="pl-hf-body" v-if="sitem.list.length > 0">
                    <div
                      class="app-pl-hf-item"
                      v-for="(replyItem, index_s) in sitem.list"
                      :key="index_s"
                    >
                      <!--                      用户头像-->
                      <div class="app-pl-hf-item-media">
                        <img
                          mode="aspectFill"
                          :src="replyItem.user_info.avatar"
                        />
                      </div>
                      <!--                      用户回复内容-->
                      <div class="app-pl-hf-item-body">
                        ...
                        <div class="app-pl-hf-item-info">
                          <div class="app-pl-list-item-user">
                            <span class="app-pl-user">{{
                              replyItem.user_info.nickname
                            }}</span
                            >回复
                            <span class="app-pl-user">{{
                              replyItem.reply_user_info.nickname
                            }}</span>
                          </div>
                        </div>
                        <!--                        回复内容-->
                          ...
                          <div class="app-pl-list-item-cont">
                            ...
                            <div v-if="replyItem.image">
                              <div class="pl-images-box">
                                <img
                                  class="pl-images"
                                  v-for="(imglist, jj) in replyItem.image"
                                  :for-item="imglist"
                                  :key="jj"
                                  :data-index="jj"
                                  :data-imgs="imglist"
                        ...
                        <div class="app-pl-list-item-item1">
                          ...
                          <div class="pl-tips" v-if="Show">
                            <div
                              class="app-pl-item-link"
                              :style="{
                                color: replyItem.is_like == 0 ? '' : '#ea7152',
                              }"
                              @click="CommentLike($event, replyItem)"
                            ...
                            <div
                              class="pl-hf"
                              :data-reply_id="replyItem.id"
                              :data-index="index_s"
                              :data-username="replyItem.user_info.nickname"
                              @click="hfSetFocus($event, index)"
                            >
                              <van-icon name="chat-o" />
                              <input
